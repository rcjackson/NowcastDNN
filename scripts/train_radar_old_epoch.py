...
def input_fn():
    ...
    labels = dataset.skip(num_frames)
  ...
  #                           activation='tanh', padding='same',
   ...
   #     return model
    ...
    with tf.Session() as sess:
        my_model = load_model('/home/rjackson/DNNmodel/model-%dframes-%03d.hdf5' % (num_frames, epoch_no))
        my_model.summary()
        dataset = input_fn()
        checkpointer = ModelCheckpoint(filepath=('/home/rjackson/DNNmodel/model-%dframes-{epoch:03d}.hdf5' % num_frames),
            verbose=1)
